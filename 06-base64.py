...
# base64 인코딩 방법
# 문자열 -> ascii 인코딩 -> base64인코딩 -> 결과값 문자열로 만들기
## 예시
sitename = 'webisfree'          # 1. 문자열
sitename_bytes = sitename .encode('ascii')  # 2. ascii 인코딩
sitename_base64 = base64.b64encode(sitename_bytes)  #3. base64인코딩
sitename_base64_str = sitename_base64.decode('ascii')   # 결과값 문자열로 만들기
